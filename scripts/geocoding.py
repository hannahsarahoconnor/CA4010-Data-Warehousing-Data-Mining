...
def url_creator(address, url='https://maps.googleapis.com/maps/api/geocode/json?address=', api_key='AIzaSyBe-vaefvOwUycBlN707CRlGhsewZq-NII'):
...
def reverse_url_creator(lat, lng, url='https://maps.googleapis.com/maps/api/geocode/json?latlng=', api_key='AIzaSyBe-vaefvOwUycBlN707CRlGhsewZq-NII'):
    return url + str(lat) + ',' + str(lng) + '&key=' + api_key


def lat_lng(address, api_key='AIzaSyBe-vaefvOwUycBlN707CRlGhsewZq-NII'):
...
def address(lat, lng, api_key='AIzaSyBe-vaefvOwUycBlN707CRlGhsewZq-NII'):
